...
public final class APassoateParaSubPasso extends PParaSubPasso
{
    ...
    public Object clone()
    {
        return new APassoateParaSubPasso(
    ...
    {
        ((Analysis) sw).caseAPassoateParaSubPasso(this);
    }

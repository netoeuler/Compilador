...
public final class APSubPasso2ParaSubPasso extends PParaSubPasso
{
    private PParaSubAte _paraSubAte_;

    public APSubPasso2ParaSubPasso()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APSubPasso2ParaSubPasso(
    ...
    {
        ((Analysis) sw).caseAPSubPasso2ParaSubPasso(this);
    }

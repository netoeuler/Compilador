...
public final class AMenorIgualOpRelacionalComp extends POpRelacionalComp
{
    private TMenorIgual _menorIgual_;

    public AMenorIgualOpRelacionalComp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMenorIgualOpRelacionalComp(
    ...
    {
        ((Analysis) sw).caseAMenorIgualOpRelacionalComp(this);
    }

...
public final class AIgualOpRelacional extends POpRelacional
{
    private TIgual _igual_;

    public AIgualOpRelacional()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAIgualOpRelacional(this);
    }

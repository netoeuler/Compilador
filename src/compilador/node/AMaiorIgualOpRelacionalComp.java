...
public final class AMaiorIgualOpRelacionalComp extends POpRelacionalComp
{
    private TMaiorIgual _maiorIgual_;

    public AMaiorIgualOpRelacionalComp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaiorIgualOpRelacionalComp(
    ...
    {
        ((Analysis) sw).caseAMaiorIgualOpRelacionalComp(this);
    }

...
public final class AMaiorOpRelacionalComp extends POpRelacionalComp
{
    private TMaior _maior_;

    public AMaiorOpRelacionalComp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaiorOpRelacionalComp(
    ...
    {
        ((Analysis) sw).caseAMaiorOpRelacionalComp(this);
    }

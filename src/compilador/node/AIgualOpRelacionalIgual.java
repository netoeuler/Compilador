...
public final class AIgualOpRelacionalIgual extends POpRelacionalIgual
{
    private TIgual _igual_;

    public AIgualOpRelacionalIgual()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIgualOpRelacionalIgual(
    ...
    {
        ((Analysis) sw).caseAIgualOpRelacionalIgual(this);
    }

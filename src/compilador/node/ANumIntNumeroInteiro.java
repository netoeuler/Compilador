...
public final class ANumIntNumeroInteiro extends PNumeroInteiro
{
    private TNumero _numero_;

    public ANumIntNumeroInteiro()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANumIntNumeroInteiro(
    ...
    {
        ((Analysis) sw).caseANumIntNumeroInteiro(this);
    }

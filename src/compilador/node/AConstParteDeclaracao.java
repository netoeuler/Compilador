...
public final class AConstParteDeclaracao extends PParteDeclaracao
{
    private TConst _const_;
    private TIdentificador _identificador_;
    private TPontoEVirgula _pontoEVirgula_;

    public AConstParteDeclaracao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AConstParteDeclaracao(
    ...
    {
        ((Analysis) sw).caseAConstParteDeclaracao(this);
    }

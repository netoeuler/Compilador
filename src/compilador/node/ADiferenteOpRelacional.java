...
public final class ADiferenteOpRelacional extends POpRelacional
{
    private TDiferente _diferente_;

    public ADiferenteOpRelacional()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADiferenteOpRelacional(
    ...
    {
        ((Analysis) sw).caseADiferenteOpRelacional(this);
    }

...
public final class ADiferenteOpRelacionalIgual extends POpRelacionalIgual
{
    private TDiferente _diferente_;

    public ADiferenteOpRelacionalIgual()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADiferenteOpRelacionalIgual(
    ...
    {
        ((Analysis) sw).caseADiferenteOpRelacionalIgual(this);
    }

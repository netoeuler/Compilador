...
public final class AMenorOpRelacionalComp extends POpRelacionalComp
{
    private TMenor _menor_;

    public AMenorOpRelacionalComp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMenorOpRelacionalComp(
    ...
    {
        ((Analysis) sw).caseAMenorOpRelacionalComp(this);
    }

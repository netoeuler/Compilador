...
public final class AMenorOpRelacional extends POpRelacional
{
    private TMenor _menor_;

    public AMenorOpRelacional()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAMenorOpRelacional(this);
    }
